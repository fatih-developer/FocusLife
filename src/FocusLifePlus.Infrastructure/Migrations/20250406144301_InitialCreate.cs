        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SpentAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false, defaultValue: 0.0m),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParentFocusCategoryId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ModifiedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Categories_Categories_ParentFocusCategoryId",
                        column: x => x.ParentFocusCategoryId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FocusNoteTag", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FocusNoteTag_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BudgetTransaction_Budgets_BudgetId",
                        column: x => x.BudgetId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    FocusCategoryId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Goals_Categories_FocusCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Habits_Categories_FocusCategoryId",
                        column: x => x.FocusCategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tasks_Categories_FocusCategoryId",
                        column: x => x.FocusCategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    FocusNoteTagId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ModifiedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ModifiedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Notes_FocusNoteTag_FocusNoteTagId",
                        column: x => x.FocusNoteTagId,
                        principalTable: "FocusNoteTag",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GoalMilestone_Goals_GoalId",
                        column: x => x.GoalId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MonthDays = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    FocusTaskId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TaskAssignments_Tasks_FocusTaskId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TaskHistories_Tasks_FocusTaskId",
                        column: x => x.FocusTaskId,
                        principalTable: "Tasks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TaskTagMappings", x => new { x.TagsId, x.TasksId });
                    table.ForeignKey(
                        name: "FK_TaskTagMappings_Tags_TagsId",
                        column: x => x.TagsId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TaskTagMappings_Tasks_TasksId",
                        column: x => x.TasksId,
                        principalTable: "Tasks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NoteTagMappings", x => new { x.NotesId, x.TagsId });
                    table.ForeignKey(
                        name: "FK_NoteTagMappings_Notes_NotesId",
                        column: x => x.NotesId,
                        principalTable: "Notes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_NoteTagMappings_Tags_TagsId",
                        column: x => x.TagsId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "Id", "CreatedAt", "CreatedBy", "DeletedAt", "DeletedBy", "Description", "IsDeleted", "ModifiedAt", "ModifiedBy", "Name", "NormalizedName", "Permissions" },
                values: new object[,]
                {
                    { new Guid("308660dc-ae51-480f-824d-7dca6714c3e2"), new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), new Guid("00000000-0000-0000-0000-000000000000"), null, null, "Sistem yöneticisi", false, null, null, "Admin", "ADMIN", null },
                    { new Guid("84eb3236-f687-4c2e-8b60-14d4ab8b5ef4"), new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), new Guid("00000000-0000-0000-0000-000000000000"), null, null, "Standart kullanıcı", false, null, null, "User", "USER", null },
                    { new Guid("8d04dce2-969a-435d-bba4-df3f325983dc"), new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("00000000-0000-0000-0000-000000000001"), null, null, "Administrator role with full access", false, null, null, "Admin", "ADMIN", null },
                    { new Guid("8d04dce2-969a-435d-bba4-df3f325983dd"), new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("00000000-0000-0000-0000-000000000001"), null, null, "Standard user role", false, null, null, "User", "USER", null }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Categories_ParentFocusCategoryId",
                table: "Categories",
                column: "ParentFocusCategoryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Habits_FocusCategoryId",
                table: "Habits",
                column: "FocusCategoryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Notes_FocusNoteTagId",
                table: "Notes",
                column: "FocusNoteTagId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NoteTagMappings_TagsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskAssignments_FocusTaskId",
                table: "TaskAssignments",
                column: "FocusTaskId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskHistories_FocusTaskId",
                table: "TaskHistories",
                column: "FocusTaskId");

            migrationBuilder.CreateIndex(
                name: "IX_Tasks_FocusCategoryId",
                table: "Tasks",
                column: "FocusCategoryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskTagMappings_TasksId",
